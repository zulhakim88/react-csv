  ...
  _createClass(CSVDownload, [{
    ...
    value: function componentDidMount() {
      ...
      if (typeof window.navigator.msSaveOrOpenBlob !== 'undefined') {
        this.state.page = window.navigator.msSaveOrOpenBlob(this.buildURI(data, uFEFF, headers, separator));
      } else {
...
var buildURI = exports.buildURI = function buildURI(data, uFEFF, headers, separator) {
  ...
  return typeof URL.createObjectURL === 'undefined' ? dataURI : typeof winNav.msSaveOrOpenBlob !== 'undefined' ? blob : URL.createObjectURL(blob);
};
